...
function StartARide() {
    ...
    <a href='/' style={{border:"none"}}><h3 style={{fontWeight:"700", textAlign:"center",fontSize:"30px", marginLeft:"0.8vh",marginRight:"-1vh", fontFamily:"Poppins", marginTop:"-1vh"}}>CARPOOLING DAPP</h3></a>
...
<div style={{border:"solid 1px black", marginLeft:'1vh', width:"58.5vw", paddingTop:"40vh"}}>
  ...
  <h4 style={{fontWeight:"700",color:'black'}}>Alert</h4>
        ...
        <Modal.Body style={{textAlign:"center"}}>
          ...
          <h4 style={{alignSelf:"center",color:'black',fontSize:"x-large"}}>Check and Update the status of this ride in the <b>Current Ride</b> section.</h4>
          </div>
        </Modal.Body>
        <Modal.Footer>
