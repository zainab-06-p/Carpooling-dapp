          ...
          for (let i = 1; i <= numRides; i++) {
            ...
            ridesList.push({
               ...
               RideSeatsAvailable:rideDetails[7],
                ...
                rideStartTime: rideDetails[12], // Add these 2 lines
                rideEndTime: rideDetails[13]    // To match updated contract
            });
          }
  ...
  return (
    ...
    <div>{!isLoading && ( <div> 
      <div className="MyNavbar">
        <a href='/' style={{border:"none"}}><h3 style={{fontWeight:"700", fontSize:"30px", fontFamily:"Poppins", textAlign:"center",marginTop:"-1vh"}}>CARPOOLING DAPP</h3></a>
  ...
  <div className="AbsoluteRight">
      ...
      <div className="TravelTime">
          <div style={{fontSize:"30px",fontWeight:"bold"}}>
            ...
            <div style={{display:"flex", flexDirection:"row"}}>
            <h5 style={{fontWeight:"700", color:"black", fontSize:"x-large",textAlign:'left',width:"11vw", paddingLeft:'2vh'}}>Start Time: </h5><h6 style={{color:"black", textAlign:"left", paddingTop:"0.5vh", fontWeight:"400"}}>{rides[rideID-1].RideDateandTime}</h6> 
            </div>
           {/* <div style={{display:"flex", flexDirection:"row"}}>
          <h5 style={{fontWeight:"700", color:"black", fontSize:"x-large",textAlign:'left',width:"30vw", paddingLeft:'2vh'}}>Fare: </h5><h6 style={{color:"black", textAlign:"left", paddingTop:"0.5vh", fontWeight:"400"}}>{rides.RideFare}SepoliaETH</h6>
          </div>*/}</div>
      </div>
